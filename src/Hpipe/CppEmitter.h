...
public:
    ...
    void              write_parse_function( StreamSepMaker &ss, const std::string &hpipe_data_name = "HpipeData", const std::string &func_name = "parse", const char *additional_args = 0, const char *class_name = 0 );
