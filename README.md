...
Here is a comparison of the performance of a basic js scanner, written with [re2c](http://re2c.org/) vs a scanner generated by hpipe (see tests/hpipe/js.hpipe and tests/re2c/js.re):
